package net.jazz.game.map {
  ...
  public class TFakeMap extends TBaseMap {
    ...
    public override function load(callback:Function):void {
      super.load(callback);
    ...
    private function fromProperties(items:XMLList):Object {
      var params:Object = {};
      for each(var property:XML in items) {
          params[property.@name] = property.@value.toString();
        }
      return params;
    }
