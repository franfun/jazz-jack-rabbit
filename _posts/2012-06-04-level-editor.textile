...
%(struct)Properties% - contains any number of fields name=value represented as %(mono)&lt;property name="NAME" value="VALUE" /&gt;%. This can be found in any element of the map. Map can contain this too.
